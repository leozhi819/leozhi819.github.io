...
<body>
	...
	<ul>
		<li><a href="../">返回首页</a></li>
		<li><a href="http://wpa.qq.com/msgrd?v=3&uin=465420700&site=qq&menu=yes" target="_blank">开发者</a></li>
		<li><a href="https://bbs.0766city.com/" target="_blank">意见反馈</a></li>
	</ul>
</div>
<div class="mt2"></div>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:50px; font-size:18px; font-weight:bold;    background-color: #ecf1fc;">阿莫之家影视解析系统登陆</td>
</tr>
		...
		<tr>
		  <td align="center" valign="middle">
		  	<p style="width:236px;text-align:left;color:#8d8d8d;" >
			  	...
			  	<span class="gray tips"><li><a href="http://wpa.qq.com/msgrd?v=3&uin=465420700&site=qq&menu=yes"需要用户名密码点击这里</span>
		  	</p>
		  </td>
		</tr>
		<tr>
...
<div class="mt"></div> 
<div class="cl10"></div>
<!--<STYLE type=text/css><!--body {background-image:url(https://ww4.sinaimg.cn/large/a15b4afegy1flzlz928x0j21hc0ose0w);background-repeat:no-repeat;background-attachment:fixed;background-position:50% 50%}--> </STYLE>-->
</body>
</html>
</html>